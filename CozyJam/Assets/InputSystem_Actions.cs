...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Dialouge"",
            ""id"": ""7ef626a9-5ef6-4c3d-9ba8-e1dd3c1dcb8a"",
            ""actions"": [
                {
                    ""name"": ""Exit"",
                    ""type"": ""Button"",
                    ""id"": ""10c8696f-e9f4-44c7-810f-1f2559a23255"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ...
                    ""type"": ""Button"",
                    ""id"": ""bc07448b-fae7-4ed0-a363-bbfca2ccf352"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""Click"",
                    ""type"": ""Button"",
                    ""id"": ""24e9bcb1-2b4d-4d6b-b8a0-38f662b0a8d2"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4075bba1-de3b-47fd-8ef5-65b8f6ca8c78"",
                    ""path"": ""<Keyboard>/tab"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""38af75e2-231c-4613-b3ac-9cc565f6d9c3"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9cb45824-1108-4790-a4d2-69c1ac1cc31b"",
                    ""path"": ""<Mouse>/leftButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_Dialouge_Exit = m_Dialouge.FindAction("Exit", throwIfNotFound: true);
        m_Dialouge_ProgressDialouge = m_Dialouge.FindAction("ProgressDialouge", throwIfNotFound: true);
        m_Dialouge_Click = m_Dialouge.FindAction("Click", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Dialouge.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Dialouge.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Dialouge_Exit;
    private readonly InputAction m_Dialouge_ProgressDialouge;
    private readonly InputAction m_Dialouge_Click;
    /// <summary>
    ...
    public struct DialougeActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public DialougeActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Dialouge/Exit".
        /// </summary>
        public InputAction @Exit => m_Wrapper.m_Dialouge_Exit;
        /// <summary>
        /// Provides access to the underlying input action "Dialouge/ProgressDialouge".
        /// </summary>
        public InputAction @ProgressDialouge => m_Wrapper.m_Dialouge_ProgressDialouge;
        /// <summary>
        /// Provides access to the underlying input action "Dialouge/Click".
        /// </summary>
        public InputAction @Click => m_Wrapper.m_Dialouge_Click;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
    ...
    public interface IDialougeActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "ProgressDialouge" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
